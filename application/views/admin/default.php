    ...
    <body class=""> 
                ...
                <ul class="nav pull-right">
                    ...
                    <li id="fat-menu" class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a tabindex="-1" href="<?= base_url() ?>super/logout.html">Logout</a></li>
                        </ul>
                    </li>
        ...
        <div class="sidebar-nav">
            ...
            <ul id="dashboard-menu" class="nav nav-list collapse in">
                <li><a href="<?= base_url() ?>super">Home</a></li>
                <li ><a href="<?= base_url() ?>super/add_doctor.html">Add Doctor</a></li>
                <li ><a href="<?= base_url() ?>super/manage_doctor.html">Manage Doctor</a></li>
                <li ><a href="<?= base_url() ?>super/add_ward.html">Add Ward</a></li>
                <li ><a href="<?= base_url() ?>super/manage_ward.html">Manage Ward</a></li>
                <li ><a href="<?= base_url() ?>super/patient.html">Patient</a></li>
            </ul>
